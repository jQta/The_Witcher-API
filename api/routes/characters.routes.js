...
const { getAllCharacters, getCharacter, getFilteredName, getFilteredRace, getFilteredGenre, getFilteredNationality, getFilteredBirth, postCharacter, deleteCharacter, putCharacter, postPicture } = require('../controllers/character.controller');
